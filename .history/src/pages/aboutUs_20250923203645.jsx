    ...
    return (
        <div className='page'>
            ...
            <div>
                ...
                <div className='excerpt_sectio'>
                    <h3 className='section_header'>Empowerment</h3>
                    <p className='section_description'>
                        We believe tradespeople should have the tools and
                        guidance to take control of their own careers — building
                        businesses that reflect their skills and ambitions.
                    </p>
                </div>
                ...
                <div className='sub_section'>
                    <h3 className='section_header'>Independence & Safety</h3>
                    <p className='section_description'>
                        Our platform provides a safer alternative to traditional
                        workplaces, helping tradespeople avoid toxic
                        environments while fostering independence and long-term
                        sustainability.
                    </p>
                </div>
            </div>
