            ...
            <article className={styles.post}>
                ...
                <section className={styles.content}>
                    ...
                    <p>
                        ...
                        got the chance to meet him via zoom, discuss our project
                        idea with him and get very useful feedback. This is the
                        time we remembered that projects like this are not
                        linear, its all about feedback, testing, iterating and
                        changing. So with our project idea not being very viable
                        considering the ability for us to help users by guiding
                        them in creating a business as well.
                    </p>
                </section>
                <section className={styles.content}>
                    <h2 className={styles.section_header}>
                    ...
                    <p>
                        ...
                        forge to become a viable product. So we took the rest of
                        the week to brainstorm ideas and do some research on the
                        challenges that individuals in trades may face.
                    </p>
                    <iframe
